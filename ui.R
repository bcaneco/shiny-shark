                          ...
                          tabsetPanel(
                            ...
                            tabPanel("Fate Model",
                                     ...
                                     fluidRow(
                                       ...
                                       column(3, beta.input("J-Hook", "LHP.J", p.value = 0.2, n.value = 200)),
                                       column(3, beta.input("T-Hook", "LHP.T", p.value = 0.3, n.value = 200))
                                     ),
                                     ...
                                     fluidRow(
                                       column(3, beta.input("Mono Leader & gut-hooked", "BOP.MG", p.value = 0.3, n.value = 200)),
                                       column(3, beta.input("Mono Leader & lip-hooked", "BOP.ML", p.value = 0.1, n.value = 200)),
                                       column(3, beta.input("Wire Leader & gut-hooked", "BOP.WG", p.value = 0.8, n.value = 200)),
                                       column(3, beta.input("Wire Leader & lip-hooked", "BOP.WL", p.value = 0.5, n.value = 200))
                                     ),
                                     ...
                                     fluidRow(
                                       column(3, beta.input("Gut-hooked", "BOM.G", p.value = 0.1, n.value = 200), offset = 3),
                                       column(3, beta.input("Lip-hooked", "BOM.L", p.value = 0.4, n.value = 2000))
                                     ), 
                                     ...
                                     fluidRow(
                                       column(3, beta.input("Gut-hooked", "RM.G", p.value = 0.1, n.value = 200), offset = 3),
                                       column(3, beta.input("Lip-hooked", "RM.L", p.value = 0.3, n.value = 1000))
                                     ), 
                                     ...
                                     fluidRow(column(3, beta.input("", "WRP", p.value = 0.1, n.value = 200), offset = 5)), 
                                     fluidRow(column(9, plotOutput("WRP"), offset = 2)),
                                     
                                     hr(),
                                     
                                     h4("Probability of mortality upon release given:"),
                                     fluidRow(column(3, beta.input("In-water release & gut-hooked", "URM.WG", p.value = 0.4, n.value = 200)),
                                              column(3, beta.input("In-water release & lip-hooked", "URM.WL", p.value = 0.1, n.value = 200)),
                                              column(3, beta.input("Landed release & gut-hooked", "URM.LG", p.value = 0.2, n.value = 200)),
                                              column(3, beta.input("Landed release & lip-hooked", "URM.LL", p.value = 0.9, n.value = 200))
                                     ),
